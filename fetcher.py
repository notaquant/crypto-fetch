"""
Fetch historical price data from Binance and Bitmex (more exchanges soon)
"""
...
def read_api_keys(filename):
    ...
    bitmex_api_key = d["BITMEX"]["API"]
    bitmex_api_secret = d["BITMEX"]["SECRET"]
    binance_api_key = d["BINANCE"]["API"]
    binance_api_secret = d["BINANCE"]["SECRET"]
    return d
